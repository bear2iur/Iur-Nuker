...
os.system(f'cls & mode 85,20 & title [Iur Nuker] - Configuration')
...
class Avery:
    ...
    def Credits(self):
        os.system(f'cls & mode 85,20 & title [Iur Nuker] - Credits')
        print(f'''
                          {self.colour}╦┬ ┬┬─┐  ┌┐┌┬ ┬┬┌─┌─┐┬─┐
                          \033[90m║│ │├┬┘  ││││ │├┴┐├┤ ├┬┘
                          \033[37m╩└─┘┴└─  ┘└┘└─┘┴ ┴└─┘┴└─

                            {self.colour}[\033[37mDiscord{self.colour}] \033[fungus player101#0744
                            {self.colour}[\033[37mGithub{self.colour}] \033[fungus player101

        \033[37m''')

    async def ThemeChanger(self):
        os.system(f'cls & mode 85,20 & title [Iur Nuker] - Themes')
        print(f'''
                          {self.colour}╦┬ ┬┬─┐  ┌┐┌┬ ┬┬┌─┌─┐┬─┐
                          \033[90m║│ │├┬┘  ││││ │├┴┐├┤ ├┬┘
                          \033[37m╩└─┘┴└─  ┘└┘└─┘┴ ┴└─┘┴└─
    ...
    async def Menu(self):
        os.system(f'cls & mode 85,20 & title [Iur Nuker] - Connected: {client.user}')
        print(f'''
                          {self.colour}╦┬ ┬┬─┐  ┌┐┌┬ ┬┬┌─┌─┐┬─┐
                          \033[90m║│ │├┬┘  ││││ │├┴┐├┤ ├┬┘
                          \033[37m╩└─┘┴└─  ┘└┘└─┘┴ ┴└─┘┴└─
